...
$rand = Get-Random -Minimum 10 -Maximum 20

# This FOR and Write-Progress function insert a nice progress bar during script execution
for ($i = $rand; $i -le 100; $i=$i+20 )
{
	Write-Progress -Activity "IMPUT YOUR MSG HERE" -Status "$i% IMPUT YOUR MSG HERE" -PercentComplete $i;
